...
class AppTextStyle {
  ...
  static TextStyle font10RegularWithGray = TextStyle(
    fontSize: 10.sp,
    fontWeight: AppFontWeight.regular,
    color: AppColors.gray,
  );
  static TextStyle font11RegularWithGray = TextStyle(
    fontSize: 11.sp,
    fontWeight: AppFontWeight.regular,
    color: AppColors.gray,
  );
  static TextStyle font12RegularWithGray400 = TextStyle(
    fontSize: 12.sp,
    fontWeight: AppFontWeight.regular,
  ...
  static TextStyle font14RegularWithGray = TextStyle(
    fontSize: 14.sp,
    fontWeight: AppFontWeight.regular,
    color: AppColors.gray,
  );
  ...
  static TextStyle font15MediumDarkBlue = TextStyle(
    fontSize: 15.sp,
    fontWeight: AppFontWeight.medium,
    color: AppColors.darkBlue,
  );
  ...
  static TextStyle font18BoldWithMattBlack = TextStyle(
    fontSize: 18.sp,
    fontWeight: AppFontWeight.bold,
